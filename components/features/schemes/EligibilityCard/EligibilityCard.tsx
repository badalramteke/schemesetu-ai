...
export default function EligibilityCard({ result, index, district, state }: EligibilityCardProps) {
      ...
      {open && (
        <div style={{ padding: "0 16px 16px", display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          {result.nextSteps && result.nextSteps.length > 0 && (
            <div>
              <p style={{ fontSize: 11, fontWeight: 600, color: "#999", margin: "0 0 8px", textTransform: "uppercase", letterSpacing: "0.05em" }}>
                📋 Next Steps
              </p>
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                {result.nextSteps.map((step, i) => (
                  <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 10, fontSize: 13, color: "#555" }}>
                    <span style={{
          ...
          <button
            ...
            style={{
              ...
              padding: "8px 0", fontSize: 12, fontWeight: 500, color: "#888",
          ...
          <div style={{
            display: "flex", alignItems: "center", justifyContent: "space-between",
            marginTop: 16, marginBottom: 16, padding: "12px 14px",
            background: "#f8f8fc", borderRadius: 12, border: "1px solid #e8e8f0"
          }}>
            <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
              <ShieldCheck size={16} color={
                result.confidence === "High" ? "#27AE60" :
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 11, color: "#888" }}>
              <Globe size={12} />
              <a href={result.sourceUrl} target="_blank" rel="noopener noreferrer" style={{ color: "#910A67", textDecoration: "none" }}>
          ...
          <div style={{ display: "flex", gap: 10 }}>
            ...
            <a
              ...
              onMouseEnter={(e) => { e.currentTarget.style.borderColor = "#910A67"; e.currentTarget.style.color = "#910A67"; }}
              onMouseLeave={(e) => { e.currentTarget.style.borderColor = "#e8e8f0"; e.currentTarget.style.color = "#777"; }}
            >
