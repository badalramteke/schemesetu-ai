...
const translations: Record<Language, Translations> = {
  en: {
    ...
    chat: {
      ...
      noSchemes: "I couldn't find matching schemes. Try adding more details — your age, occupation, income, location. 🙏",
      foundSchemes: (count) => `I found ${count} scheme${count > 1 ? "s" : ""} that may be relevant to you:`,
      ...
      sectors: {
        agriculture: { label: "Agriculture", query: "agriculture and farming schemes" },
        healthcare: { label: "Healthcare", query: "health and medical schemes" },
        housing: { label: "Housing", query: "housing and shelter schemes" },
        employment: { label: "Employment", query: "employment and work schemes" },
        pension: { label: "Pension", query: "pension and retirement schemes" },
        education: { label: "Education", query: "education and skills schemes" },
      },
    },
    header: { newChat: "New Chat" },
    sidebar: {
      home: "Home", newChat: "New Chat", settings: "Settings",
      faq: "FAQ / Help", contact: "Contact Us", about: "About",
      privacy: "Privacy Policy", tagline: "AI Scheme Advisor", footer: "Made for rural India 🇮🇳",
    },
    conversational: {
      questionsPrefix: "Just one quick question to find the right schemes for you:",
      readyMessage: "Perfect! Let me check all matching schemes now. This usually takes 30–40 seconds… ⏳",
      preferNotToAnswer: "🔒 Prefer not to answer",
      borderline: "Based on what you've shared, you're likely eligible — one more detail will confirm.",
  ...
  hi: {
    ...
    chat: {
      ...
      foundSchemes: (count) => `मुझे ${count} योजना${count > 1 ? "एं" : ""} मिली जो आपके लिए उपयोगी हो सकती हैं:`,
      ...
      sectorPrompt: (query) => `मुझे ${query} के बारे में बताएं जिनके लिए मैं पात्र हो सकता हूँ`,
      ...
      sectors: {
        ...
        healthcare: { label: "स्वास्थ्य", query: "स्वास्थ्य और चिकित्सा योजनाएं" },
    ...
    sidebar: {
      home: "होम", newChat: "नई चैट", settings: "सेटिंग्स",
      faq: "सवाल-जवाब / मदद", contact: "संपर्क करें", about: "जानकारी",
      privacy: "गोपनीयता नीति", tagline: "AI योजना सलाहकार", footer: "ग्रामीण भारत के लिए बनाया गया 🇮🇳",
    },
    conversational: {
      questionsPrefix: "सही योजना खोजने के लिए बस एक सवाल:",
      readyMessage: "बढ़िया! अब मैं आपके लिए सभी योजनाएं जांच रहा हूँ। इसमें 30–40 सेकंड लगेंगे… ⏳",
      preferNotToAnswer: "🔒 बताना नहीं चाहता",
      borderline: "आपकी जानकारी के अनुसार, आप शायद पात्र हैं — एक और जानकारी से पक्का हो जाएगा।",
  ...
  mr: {
    ...
    chat: {
      ...
      noSchemes: "कोणतीही योजना सापडली नाही। वय, व्यवसाय, उत्पन्न, ठिकाण सांगा. 🙏",
      foundSchemes: (count) => `मला ${count} योजना सापडल्या ज्या तुमच्यासाठी उपयुक्त असू शकतात:`,
      ...
      sectorPrompt: (query) => `मला ${query} बद्दल सांगा ज्यासाठी मी पात्र असू शकतो`,
    ...
    sidebar: {
      home: "होम", newChat: "नवीन चॅट", settings: "सेटिंग्ज",
      faq: "प्रश्न-उत्तर / मदत", contact: "संपर्क करा", about: "माहिती",
      privacy: "गोपनीयता धोरण", tagline: "AI योजना सल्लागार", footer: "ग्रामीण भारतासाठी बनवले 🇮🇳",
    },
    conversational: {
      questionsPrefix: "योग्य योजना शोधण्यासाठी एक प्रश्न:",
      readyMessage: "छान! आता मी तुमच्यासाठी सर्व योजना तपासतो. 30–40 सेकंद लागतील… ⏳",
      preferNotToAnswer: "🔒 सांगायचे नाही",
      borderline: "तुम्ही दिलेल्या माहितीनुसार तुम्ही पात्र असण्याची शक्यता आहे — एक अधिक तपशील खात्री करेल.",
