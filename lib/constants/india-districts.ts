// Complete State → Districts map for India (28 states + major UTs)
// Used by OnboardingWizard to cascade district dropdown from state selection.
...
export const INDIA_DISTRICTS: Record<string, string[]> = {
  "Andhra Pradesh": [
    ...
    "Kurnool","Nandyal","Nellore","NTR","Palnadu","Parvathipuram Manyam",
  ...
  "Madhya Pradesh": [
    ...
    "Narmadapuram","Indore","Jabalpur","Jhabua","Katni","Khandwa","Khargone",
  ...
  "Mizoram": [
    ...
    "Lunglei","Mamit","Saiha","Saitual","Siaha",
  ],
  "Nagaland": [
  ...
  "Sikkim": ["East Sikkim","Gyalshing","North Sikkim","Pakyong","Soreng","South Sikkim"],
  "Tamil Nadu": [
  ...
  "Telangana": [
    "Adilabad","Bhadradri Kothagudem","Hanmakonda","Hyderabad","Jagtial",
...
/** Returns the sorted district list for a given state, or [] if not found */
export function getDistricts(state: string): string[] {
  return (INDIA_DISTRICTS[state] ?? []).slice().sort((a, b) => a.localeCompare(b));
}
