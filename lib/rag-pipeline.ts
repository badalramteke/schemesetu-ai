...
// Re-export client-safe types and functions so existing server-side imports still work
export type {
  EligibilityResult,
  NoMatchScheme,
  DynamicTurn,
  WizardQuestion,
  RAGEcosystemResponse,
} from "./rag-pipeline-client";
export { detectUserIntent } from "./rag-pipeline-client";
